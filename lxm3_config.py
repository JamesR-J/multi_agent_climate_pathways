...
def sweep_SWEEP():
    ...
    num_agents = [3]
    reward_function = ['"PB", "max_Y", "max_Y"', '"PB", "PB", "max_Y"', '"PB", "PB", "PB"']  # TODO assertion for length of this and num agents innit
    ...
    result = [{"seed": seed,
               ...
               "num_agents": agent,
               "reward_type": reward,
               "disable_jit": False} for seed, homo, agent, reward in combinations]
