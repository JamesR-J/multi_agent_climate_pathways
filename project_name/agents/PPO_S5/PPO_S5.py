...
# from network import ActorCriticRNN, ScannedRNN
from functools import partial
from project_name.agents.PPO_S5.network import ActorCriticS5  # TODO sort out this class import ting
...
class PPO_RNNAgent:
    def __init__(self,
        ...
        self.network = ActorCriticS5(env.action_space(env.agents[0]).n, config=config,
                                     ssm_init_fn=ssm_init_fn)  # TODO discrete space but can be continuous
        ...
        self.init_hstate = StackedEncoderModel.initialize_carry(config["NUM_ENVS"], ssm_size, n_layers)
    ...
    def act(self, train_state: Any, hstate: Any, ac_in: Any, key: Any):  # TODO better implement checks
        ...
        return train_state, hstate, action, log_prob, value, key  # TODO may need to squeeze some bits
    ...
    def update(self, runner_state, traj_batch):
        ...
        def _calculate_gae(traj_batch, last_val):
            def _get_advantages(gae_and_next_value, transition):
                gae, next_value = gae_and_next_value  # TODO do we need a next done here?
                done, value, reward = (
