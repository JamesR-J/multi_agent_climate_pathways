...
_EXP_NAME = flags.DEFINE_string("exp_name", "coop_agent_sweep", "Name of experiment")
        ...
        envs = [
            {
                ...
                # "WANDB_NAME": f"{experiment_name}_{xid}_{wid}",  # this is yicheng original
                "WANDB_NAME": f"{experiment_name}_{wid}",
